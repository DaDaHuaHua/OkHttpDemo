...
public class BitmapCache {
    ...
    //默认的磁盘缓存大小
    private static final int DEFAULT_DISK_CACHE_SIZE = 1024 * 1024 * 200; // 200MB
    ...
    */
    ...
    public void addToDiskCache(String url, Bitmap bm) {
    	if (url!=null && bm!=null) {
    		ByteArrayOutputStream baos = new ByteArrayOutputStream();  
    		bm.compress(Bitmap.CompressFormat.PNG, 100, baos);  
    		addToDiskCache(url, baos.toByteArray());			
		}
    }
    /**
     * 从sdcard中获取内存缓存
