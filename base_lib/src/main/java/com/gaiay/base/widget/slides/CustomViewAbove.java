...
import com.gaiay.base.widget.slides.SlidingMenu.OnClosedListener;
import com.gaiay.base.widget.slides.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		if (isFilterY) {
			if (ev.getY() > topY && ev.getY() < bottomY) {
				return false;
			}
		}
		if (!mEnabled)
